...
echo '<title>Student Login</title>';
echo '</head>';
echo '<body><div id="wrapper">';
echo '<h1>Student Login</h1>';

echo '<form action="registration.php" method="post">';
echo '<fieldset><Legend>Enter student id and password</Legend>';

echo 'Username: ' . '<input type="text" name="username"><br><br>';
echo 'Password: ' . '<input type="password" name="password"><br><br>';
echo '</fieldset><input type="submit" value="Submit"><br>';
echo 'New user? ' . '<a href="register.php">Click here to register.</a>';
echo ' </form> </div><div class="clearfooter"></div><div id="footer">';

echo '<br>Copyright&copy; ~~';
echo '2015 Zach McAlexander, Eric Horne, Robert Barwick</div>';
echo '</body></html>';
